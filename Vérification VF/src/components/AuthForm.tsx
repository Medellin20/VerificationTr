...
const referenceLabels: Record<Language, { label: string; placeholder: string }> = {
  fr: { label: "Référence de la carte", placeholder: "Saisissez la référence" },
  en: { label: "Card reference", placeholder: "Enter the reference" },
  de: { label: "Kartenreferenz", placeholder: "Referenz eingeben" },
  it: { label: "Riferimento della carta", placeholder: "Inserisci il riferimento" },
  es: { label: "Referencia de la tarjeta", placeholder: "Introduce la referencia" },
};
